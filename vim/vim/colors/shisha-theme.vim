" Vim color file
" Maintainer: Alexander Shishckin <shisha@shisha.spb.ru>
" Last Change: 16-08-2003
" Version: 0.1
" URI: http://shisha.spb.ru/
" Made out of nightshimmer-theme
...
let g:colors_name = "shisha-theme"
...
highlight LineNr        gui=bold guibg=#103040 guifg=#308060 font=-artwiz-*-*-*-*-*-14-*-*-*-*-*-*-*
...
if version < 600
	...
	highlight NonText       gui=None guifg=Purple
	" guibg=bg
endif
highlight Normal        gui=None guibg=#001020 guifg=SeaGreen
highlight Question      gui=bold  guifg=SeaGreen2
" guibg=bg
highlight Search        gui=NONE guibg=Purple4 guifg=NONE
highlight SpecialKey    guibg=#123A4A guifg=#426272
highlight StatusLine    gui=bold guibg=#304060 guifg=Orange
highlight StatusLineNC  gui=NONE guibg=#303030 guifg=grey
highlight Title         gui=bold  guifg=MediumOrchid1
" guibg=bg
highlight Visual        gui=reverse guibg=WHITE guifg=SeaGreen
highlight VisualNOS     gui=bold guifg=fg
" guibg=bg
highlight WarningMsg    gui=bold guifg=FireBrick1
" guibg=bg
...
highlight Comment       gui=None guifg=#006699
highlight Constant      gui=None guifg=Orange
highlight String		guifg=LightBlue
"gui=underline
...
highlight Statement     gui=Bold guifg=#40e8ee
highlight Conditional gui=Bold guifg=#20c0ff
" guibg=bg
highlight Repeat gui=Bold guifg=#6060c0
" guibg=bg
    "hi Label gui=None guifg=LightGreen guibg=bg
highlight Operator gui=Bold guifg=Chartreuse
" guibg=bg
highlight Keyword gui=Bold guifg=DarkGreen
" guibg=bg
highlight Exception gui=Bold guifg=LightGreen
" guibg=bg

highlight PreProc       guifg=Coral ctermfg=3
	"highlight Include		gui=None guifg=MediumPurple1 guibg=bg
...
highlight Underlined gui=underline guifg=honeydew4
" guibg=bg
...
highlight Todo          guifg=darkred guibg=white gui=bold
